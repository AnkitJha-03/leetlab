/*
  ...
  - You are about to drop the column `Passed` on the `TestCaseResult` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "TestCaseResult" DROP COLUMN "Passed",
